      ...
      <div>
        <div className="flex flex-col lg:flex-row mt-[49px] gap-[29px] lg:gap-[49px] px-[20px]">
          ...
          <div className="w-full lg:flex-1 text-white text-center lg:text-start flex flex-col space-y-[40px] font-poppins">
            <p> 
            Gbenga is a trailblazer in agriculture and food processing in Southwest Nigeria, best known for his transformative work through Titan Farms and its flagship product,
 Titan Rice which he set up in 2019 as the Head of Business. Titan Rice quickly became a national sensation, recognised for its high quality and local production, which significantly 
contributed to food security and economic empowerment in Nigeria. The success of Titan Farms drew widespread attention from various sectors, including political leaders, traditional rulers,
              and business elites, positioning Gbenga as a key figure in the agricultural industry.
            </p>
            <p>
            To celebrate the farm’s success, Titan Farms organised a National Food Sustainability Summit during its anniversary, bringing together stakeholders from across Nigeria.
              The event featured lawmakers from both state and federal levels, alongside a prestigious lineup of traditional rulers. Notable attendees included HRH Alhaji Ado Bayero CFR, 
the Emir of Kano; Alhaji Yahaya Abubarkar CFR, the Etsu Nupe of Niger; Ooni Adeyeye Enitan Ogunwusi CFR, the Ooni of Ife; Oba Saliu Adetunji, the Olubadan of Ibadan, and ten other revered 
traditional rulers. The summit highlighted Gbenga’s leadership in promoting agricultural sustainability and his vision for a food-secure Nigeria, further cementing his influence at both the 
grassroots and national levels.
            </p>
            <p>
            Before establishing Hybrid Improvements, Gbenga honed his expertise in business operations as the Head of Business and Director of Business Improvement at Titan Multi Business 
Limited in Nigeria, where he oversaw a team of over 300 employees and increased market share by 20%.
            </p>
            <p>
            Here, he showcased his expertise in Financial Technology, Agricultural Technology, and Real Estate Technology. His work in these fields is driven by a passion for
              simplifying payments, enhancing agricultural productivity, and innovating in real estate.
            </p>
            <p>
              His leadership acumen extends beyond operations, making significant impacts in business turnaround strategies during times of crisis, a period that 
threw the company into controversies and distraught.
            </p>
            <p>
              His influence extends beyond the business realm into philanthropy. The Aare Gbenga Eyiolawi Foundation, founded in 2018, exemplifies his commitment 
to education and social welfare. The foundation has awarded scholarships to over 457 primary school students, 125 secondary school students, and supports more than 
100 tertiary students in Nigeria. This initiative underscores Gbenga's dedication to empowering the next generation.
            </p>
            <p>
              Gbenga's impact has been recognised both locally and internationally.
            </p>
            <p>
              In 2021, he was honoured with the prestigious Royal African Youth Leadership Award by the Ooni of Ife for his contributions to youth empowerment and 
leadership in Africa. In recognition of his community-focused initiatives and commitment to eradicating hunger, Gbenga was bestowed the chieftaincy title of Aare 
Kebimapalu (Anti-hunger Marshal) of Ibadan-land by the Olubadan of Ibadan, a testament to his relentless efforts in fostering economic growth and social development.
            </p>
            <p>
              These are amongst other numerous awards from international bodies.
His inspirational story was further highlighted when he spoke at the United Nations Economic Commission for Africa in 2021, sharing his vision and experience with 
prominent African economic leaders.
            </p>
            <br />
              <p>
                Gbenga holds a range of certifications and affiliations that reflect his expertise and leadership in the field.
              </p>
              <p>
